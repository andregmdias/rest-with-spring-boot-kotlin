...
import br.com.giannatech.restwithspringbootkotlin.mapper.DozerMapper.parseObject
import br.com.giannatech.restwithspringbootkotlin.mocks.MockPerson
...
class DozerMapperTest {
    ...
    fun parseEntityToVOTest() {
        val output: PersonVO = parseObject(inputObject!!.mockEntity(), PersonVO::class.java)
    ...
    fun parseVOToEntityTest() {
        ...
        val output: Person = parseObject(inputObject!!.mockVO(), Person::class.java)
